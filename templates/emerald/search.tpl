...
{IF NOT SEARCH->match_type "USER_ID"}
    ...
    <div class="generic" id="search-form">
        ...
        <form action="{URL->ACTION}" method="get">
            ...
            <select name="match_fields">
                <option value="BOTH" {IF SEARCH->match_fields "BOTH"}selected="selected"{/IF}>{LANG->mod_sphinx_search->MatchBoth}</option>
                <option value="BODY" {IF SEARCH->match_fields "BODY"}selected="selected"{/IF}>{LANG->mod_sphinx_search->MatchBody}</option>
                <option value="SUBJECT" {IF SEARCH->match_fields "SUBJECT"}selected="selected"{/IF}>{LANG->mod_sphinx_search->MatchSubject}</option>
            </select>
